...
@section('content')
    <div class="container px-6 py-12 mx-auto">
        <h1 class="px-6 mb-8 text-3xl font-bold text-[#051923] border-l-8 border-[#051923]">My Orders</h1>
    ...
    <div class="fixed inset-0 z-50 items-center justify-center hidden bg-gray-900 bg-opacity-50 backdrop-blur-sm"
        ...
        <form action="{{ route('order.destroy', '') }}" method="POST" class="p-8 bg-white rounded-lg shadow-lg">
            ...
            <div class="flex gap-4">
                <button type="submit" class="px-4 py-2 text-white bg-[#051923] rounded hover:bg-[#051923]">Yes,
                    Cancel</button>
