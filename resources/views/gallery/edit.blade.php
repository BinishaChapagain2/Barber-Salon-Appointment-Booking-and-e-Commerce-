...
@section('title')
    Update Gallery | Gentleman BarberShop
@endsection

@section('headerofadmin')
    <div class="w-full px-4 py-4 bg-[#051923] shadow-md text-white">
        <i class="bx bx-menu menu-icon"></i>
        <span class="font-medium logo-name lg:text-lg">Update Photo</span>
    </div>
@endsection
...
@section('content')
    <div class="flex flex-col flex-1 w-full h-auto bg-gray-300">
        ...
        <div class="w-full p-8 bg-white rounded-lg shadow-md">
            <h2 class="mb-6 text-xl font-bold">Edit Photo</h2>
            <form action="{{ route('gallery.update', $gallery->id) }}" method="POST" enctype="multipart/form-data"
                ...
                <div>
                    ...
                    @enderror
                    <p>Current Picture:</p>
                    <img src="{{ asset('images/galleries/' . $gallery->photopath) }}" alt="" class="w-44">
                </div>
                ...
                <div class="flex justify-between w-full">
                    <button type="submit"
                        class="px-4 py-3 font-semibold text-white bg-blue-600 rounded-md hover:bg-blue-700">Update Your
                        Gallery</button>
