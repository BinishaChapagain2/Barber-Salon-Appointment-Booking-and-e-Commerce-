...
@section('content')
    <div class="checkout-container"
        style="display: flex; flex-wrap: wrap; gap: 20px; padding: 20px; background-color: #f9f9f9; border-radius: 8px;">
        ...
        <div class="payment-options"
            ...
            <form action="{{ route('buynow.placeOrder') }}" method="POST" style="margin-bottom: 20px;">
                ...
                <button type="submit"
                    style="display: block; width: 100%; padding: 10px; background-color: #002952; color: #fff; border: none; border-radius: 4px; font-size: 16px;">
