...
@section('content')
    <div class="container px-6 py-12 mx-auto">
        <h1 class="px-6 mb-8 text-3xl font-bold text-[#051923] border-l-8 border-[#051923]">My History</h1>

        @if ($ordershistory->isEmpty())
            <div class="p-6 mb-8 text-[#051923] bg-yellow-100 border-l-8 border-[#051923] rounded-lg shadow">
    ...
    <div class="fixed inset-0 z-50 items-center justify-center hidden bg-gray-900 bg-opacity-50 backdrop-blur-sm"
        ...
        <form action="{{ route('cancelhistory.destroy', '') }}" method="POST" class="p-8 bg-white rounded-lg shadow-lg">
            ...
            <div class="flex gap-4">
                <button type="submit" class="px-4 py-2 text-white bg-[#051923] rounded hover:bg-yellow-600">Yes,
                    Cancel</button>
